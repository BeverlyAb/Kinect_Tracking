...
namespace Microsoft.Samples.Kinect.FaceBasics
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        {
            ///////////////////////////////
            this.my_serial = new SerialPort();
            this.my_serial.BaudRate = 9600;
            this.my_serial.PortName = "COM15"; //15
        ...
        public int convert_x_degrees(int faceIndex)
        {
            ...
            float x_degree = headJoint.X * 1000; // convert to decimal -800 to 800 range         

            x_degree= (int)(x_degree / (800 / 90) + 90);
            if (x_degree < 0)
            {
                x_degree = 0;
            }
            else if (x_degree > 180)
            {
                x_degree = 180;
            }
