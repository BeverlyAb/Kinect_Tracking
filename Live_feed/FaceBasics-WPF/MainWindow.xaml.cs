...
namespace Microsoft.Samples.Kinect.FaceBasics
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        /// <summary> 
        /// Reader for color frames BA
        /// </summary>
        private ColorFrameReader colorFrameReader = null;

        /// <summary>
        /// Bitmap to display BA
        /// </summary>
        private WriteableBitmap colorBitmap = null;

        /// <summary>
        /// Current status text to display BA
        /// </summary>
        ...
        /// <summary>
        /// Handles the color frame data arriving from the sensor BA
        /// </summary>
                        ...
                        for (int i = 0; i < this.bodyCount; i++)
                        {
                            ...
                            if (this.faceFrameSources[i].IsTrackingIdValid)
                            {
                                ...
                                if (this.faceFrameResults[i] != null)
                                {
                                    ...
                                    Debug.WriteLine("degree " + Convert.ToString(i));
                                    if (!drawFaceResult)
                                    {
                                        drawFaceResult = true;
                                    }
        ...
        /// <summary>
        //Convert positions to degrees and sends to motor BA
        /// </summary>
